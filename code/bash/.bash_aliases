...
alias ll='ls  -lAFh --group-directories-first'		# all details
alias lr='ls -ARF1 --group-directories-first'		# list contents of subfolders
...
alias git_ps="git submodules update --init --recursive"
alias git_us="git submodules update --init --recursive --remote"
alias gfs="git fetch --all -p; git status"
